...
var studentsResource = schema.GroupVersionResource{Group: "stable.k8s.io", Version: "v1", Resource: "students"}

var studentsKind = schema.GroupVersionKind{Group: "stable.k8s.io", Version: "v1", Kind: "Student"}
